...
public class CamDrive : MonoBehaviour {
	...
	void Start () {
        ...
        {
            IntroCam = GameObject.FindGameObjectWithTag ("IntroCam");
            IntroCam.GetComponent<Camera> ().enabled = true;
            IntroCam.transform.localPosition = NavPoints [0].position;
